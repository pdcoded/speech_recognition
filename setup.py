...
class CustomCommands(install):
  ...
  def run(self):
    ...
    self.RunCustomCommand(['pip','install','https://github.com/kpu/kenlm/archive/master.zip'])
    self.RunCustomCommand(
    ['pip', 'install', 'git-lfs','pandas', 
     'progressbar2', 'python-utils',
     'numpy', 'scipy', 'paramiko', 'pysftp',
     'sox', 'python_speech_features', 'pyxdg',
     'bs4','Cython','six','requests==2.18.0','google-cloud==0.27.0'])
    install.run(self)
